        ...
        <Paper elevation={3} sx={{ p: 3 }}>
            ...
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={tabValue} onChange={handleTabChange} aria-label="schedule view tabs">
                    <Tab icon={<DateRangeOutlined />} label="日历视图" id="tab-0" />
                    <Tab icon={<ScheduleOutlined />} label="列表视图" id="tab-1" />
                    <Tab icon={<InfoOutlined />} label="教师视图" id="tab-2" />
                    <Tab icon={<InfoOutlined />} label="教室视图" id="tab-3" />
                </Tabs>
            </Box>
